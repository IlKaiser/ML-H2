...
for i in range(9):
  ...
  plt.imshow(image_batch[i+10].astype("uint8"))
  plt.title(classnames[np.argmax(score[i+10])]+"/"+classnames[label_batch[i+10]])
  plt.axis("off")
...
img = tf.keras.preprocessing.image.load_img(
    "test/dpn.jpg", target_size=(img_height, img_width)
)
